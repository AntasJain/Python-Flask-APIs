...
class Tag(MethodView):
    ...
    @blp.alt_response(400, description="Returned if the tag is assigned to one or more items. In this case, the tag is not deleteds")
    def delete(self, tag_id):
        ...
        abort(400, message="Can't delete the tag, make sure no item is linked to the tag")
